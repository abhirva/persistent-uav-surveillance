...
from uav_surveil.stage2_fleet import optimize_fleet_from_config, validate_fleet_configuration
...
def test_fleet_spare_ratio():
    ...
    assert validate_fleet_configuration(result.n_launch, result.n_spare, cfg.optimization.spare_floor_ratio) 